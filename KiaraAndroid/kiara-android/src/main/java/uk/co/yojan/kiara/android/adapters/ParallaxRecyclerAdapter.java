...
public class ParallaxRecyclerAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  private SwipeDismissRecyclerViewTouchListener swipeDismissRecyclerViewTouchListener;
    ...
    view.setOnScrollListener(new RecyclerView.OnScrollListener() {
      ...
      public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
        if(swipeDismissRecyclerViewTouchListener != null) {
          Log.d("ParallaxRecyclerAdapter", "Setting enabled or something..");
          swipeDismissRecyclerViewTouchListener.setEnabled(newState != AbsListView.OnScrollListener.SCROLL_STATE_TOUCH_SCROLL);
        }
      }
    });
  }
  ...
  public void setSwipeDismissRecyclerViewTouchListener(SwipeDismissRecyclerViewTouchListener listener) {
    this.swipeDismissRecyclerViewTouchListener = listener;
  }
