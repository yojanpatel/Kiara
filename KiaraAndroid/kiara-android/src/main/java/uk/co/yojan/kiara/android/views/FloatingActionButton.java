...
/*
 * An implementation for the Floating Action Button UX design pattern
 * as suggested by Google's material design. The two main elements to be specified
 * are the button colour and the drawable.
 *
 * Usage:
 * FloatingActionButton fab =
 *   new FloatingActionButton.Builder(this).withDrawable(..).withButtonColor(..).create();
 */
public class FloatingActionButton extends View {
  ...
  static public class Builder {
    ...
    // The calculation (value * scale + 0.5f) is used to convert from dps
    // from pixels based on density scale
